...
```{r, fig.cap = "**Figure 1.** California map of the number of inland oil spill events by country in 2008. Modoc County is not included as it had zero spill events. Data: California Department of Fish and Wildlife. 2009."}
